...
const RBTICandidateResponsibility = () => {
  ...
  const handleFormPost = async () => {
    const formData = {
      category: "rbti_candidate_responsibility",
    ...
    const getData = async () => {
      try {
        const response = await axios.get(
          `${host.url}/data/rbti/rbti_candidate_responsibility`,
          config
        );
    ...
    <>
      <div className="h-fit w-full flex flex-col pb-[100px] md:pb-20">
        <div className="w-full my-5 bg-[whitesmoke] px-5 flex flex-col h-screen ">
          <div className="p-5">
            <h1 className={cn(`font-bold`)}>RBTI - Candidate Responsibility</h1>
          </div>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => {
                    ...
                    return (
                      <FormItem>
                        <FormLabel>RBTI -Candidate Responsibility</FormLabel>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="rbti_candidate_responsibility">
                              RBTI - Candidate Responsibility
                            </SelectItem>
                          </SelectContent>
                        </Select>
...
export default RBTICandidateResponsibility;
