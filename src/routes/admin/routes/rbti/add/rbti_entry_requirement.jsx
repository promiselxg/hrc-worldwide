...
const RBTIEntryRequirement = () => {
  ...
  const handleFormPost = async () => {
    const formData = {
      category: "rbti_entry_requirement",
    ...
    const getData = async () => {
      try {
        const response = await axios.get(
          `${host.url}/data/rbti/rbti_entry_requirement`,
          config
        );
    ...
    <>
      <div className="h-fit w-full flex flex-col pb-[100px] md:pb-20">
        <div className="w-full my-5 bg-[whitesmoke] px-5 flex flex-col h-screen ">
          <div className="p-5">
            <h1 className={cn(`font-bold`)}>RBTI - Entry Requirement</h1>
          </div>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => {
                    ...
                    return (
                      <FormItem>
                        <FormLabel>RBTI - Entry Requirement</FormLabel>
                        <Select
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="rbti_entry_requirement">
                              RBTI - Entry Requirement
                            </SelectItem>
                          </SelectContent>
                        </Select>
...
export default RBTIEntryRequirement;
