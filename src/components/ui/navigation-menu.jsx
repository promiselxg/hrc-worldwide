...
const navigationMenuTriggerStyle = cva(
  "group flex  items-center text-[16px] uppercase font-lato font-[600] transition-colors hover:bg-accent hover:text-white focus:bg-transparent focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-transparent data-[state=open]:bg-transparent data-[state=open]:text-white"
);
